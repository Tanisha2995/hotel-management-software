...
def Booking():
    ...
    if p1 not in phno:
        ...
        for n in range(0, i):
            if p1 == phno[n]:
                if p[n] == 0:
                    print('\tPhone no. already exists and payment is not done..!!!')
                    name.pop(i)
                    add.pop(i)
                    checkin.pop(i)
                    checkout.pop(i)
...
attached washroom with hot/cold water.\n''')
    ...
    print("----------------------------------------------------------")
    print('''Room amenities include: 1 Double Bed + 1 Single Bed, Television,
Telephone, a Triple-Door Cupboard, 1 Coffee table with 2 sofa, 1 Side table,
Balcony with an Accent table with 2 Chair and an attached washroom with hot/cold
        ...
        if ph == phno[n]:
            if p[n] == 0:
                ...
                if ch == 'y' or ch == 'Y':
                    ...
                    print('-----------------------------')
                    print('Name:', name[n], '\t\nPhone No:', phno[n], '\t\nAddress:', add[n], '\t')
                    print('Check In:', checkin[n], '\t\nCheck-out:', checkout[n], '\t')
                    print('\nRoom Type:', room[n], '\t\nRoom Charges:', price[n] * day[n] + rc[n], '\t')
                    print('------------------------------')
                    print('      Thank You')
                    print('      visit Again:)')
                    print('------------------------------')
